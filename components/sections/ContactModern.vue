            ...
            <div class="row align-items-end">
                <div class="col-lg-6 col-12 pr--50 ptb-md--80 ptb-sm--80">
                    <div class="contact-modern bg_color--18 space_dec--100 pt--120 pb--120 pl--60 pr--60">
                        <div class="inner">
                            <h2 class="heading heading-h2 text-white" v-html="contentData?.content"></h2>

                            <div class="classic-address text-left mt--60">
                                <h4 class="heading heading-h4 text-white">Visit our studio at</h4>
                                <div class="desc mt--15">
                                    <p class="bk_pra line-height-2-22 text-white" v-html="contentData?.children?.[1]?.content"></p>
                                </div>
                            </div>
                            ...
                            <div class="classic-address text-left mt--60">
                                ...
                                <div class="desc mt--15 mb--30">
                                    <p class="bk_pra line-height-2-22 text-white" v-html="contentData?.children?.[0]?.content"></p>
                                </div>
...
export default {
  ...
  async mounted() {
    ...
    const filterData = JSON.parse(
      JSON.stringify(data?.filter((sec) => sec?.section === "contact-1")[0])
    );
