<template>
  <div class="main-container">
    ...
    <div
      class="brook-gradation-area ptb--150 ptb-md--80 ptb-sm--60 bg_color--1"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="brook-section-title text-center">
              ...
              <h3 class="heading heading-h3" v-html="contentData?.content"></h3>
            </div>
            <GradationOne />
          </div>
        </div>
...
export default {
  components: {
    ...
    ServiceClassicBreadcrumb: () =>
      import("@/components/ServiceClassicBreadcrumb"),
  ...
  async mounted() {
    ...
    const filterData = JSON.parse(
      JSON.stringify(data?.filter((sec) => sec?.section === "tvp-3")[0])
    );
